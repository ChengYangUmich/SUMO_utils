...
# Creat heatmap for Sensitivity Analysis `create_heatmap()`
# Specify inputs
fig, axs = plt.subplots(1,1,figsize = (6,4)) 
x_name = 'Sumo__Plant__MBBR2__param__MABR_SSA'
y_name = 'Sumo__Plant__Sideflowdivider1__param__Qpumped_target'
z_name = 'Sumo__Plant__Effluent1__SNHx'
...
fig.savefig(".\Pics\LineAndScatter.heatmap.jpg")
